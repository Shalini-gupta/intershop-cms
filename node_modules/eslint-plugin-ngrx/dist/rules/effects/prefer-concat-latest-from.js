...
function getSelectorWithSourceCode(context, { strict }) {
    if (strict) {
        return {
            selector: `${utils_1.createEffectExpression} CallExpression > Identifier[name='withLatestFrom']`,
    ...
    return {
        selector: `${utils_1.createEffectExpression} ${(0, utils_1.namedExpression)(actionsNames)} > CallExpression[arguments.length=1] > Identifier[name='${withLatestFromKeyword}']`,
        sourceCode,
    };
}
