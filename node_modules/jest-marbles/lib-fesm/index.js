...
const customTestMatchers = {
    toBeNotifications(actual, expected) {
        ...
        const message = pass
            ...
            : () => {
                const diffString = Object(external_jest_diff_["diff"])(expectedMarble, actualMarble, {
                    expand: true,
                });
    ...
    toBeSubscriptions(actual, expected) {
        ...
        const message = pass
            ...
            : () => {
                const diffString = Object(external_jest_diff_["diff"])(expectedMarbleArray, actualMarbleArray, {
                    expand: true,
                });
...
class scheduler_Scheduler {
    static init() {
        scheduler_Scheduler.instance = new testing_["TestScheduler"](assertDeepEqual);
    }
    static get() {
