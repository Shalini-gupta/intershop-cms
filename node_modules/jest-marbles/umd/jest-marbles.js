(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("expect/build/jasmineUtils"), require("jest-diff"), require("jest-matcher-utils"), require("rxjs"), require("rxjs/testing"));
	else if(typeof define === 'function' && define.amd)
		define("JestMarbles", ["expect/build/jasmineUtils", "jest-diff", "jest-matcher-utils", "rxjs", "rxjs/testing"], factory);
	else if(typeof exports === 'object')
		exports["JestMarbles"] = factory(require("expect/build/jasmineUtils"), require("jest-diff"), require("jest-matcher-utils"), require("rxjs"), require("rxjs/testing"));
	else
		root["JestMarbles"] = factory(root["expect/build/jasmineUtils"], root["jest-diff"], root["jest-matcher-utils"], root["rxjs"], root["rxjs/testing"]);
})((typeof self !== 'undefined' ? self : this), function(__WEBPACK_EXTERNAL_MODULE_expect_build_jasmineUtils__, __WEBPACK_EXTERNAL_MODULE_jest_diff__, __WEBPACK_EXTERNAL_MODULE_jest_matcher_utils__, __WEBPACK_EXTERNAL_MODULE_rxjs__, __WEBPACK_EXTERNAL_MODULE_rxjs_testing__) {
...
/*! ModuleConcatenation bailout: Cannot concat with external "jest-diff" (<- Module is not an ECMAScript module) */
...
/*! ModuleConcatenation bailout: Cannot concat with external "rxjs/testing" (<- Module is not an ECMAScript module) */
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "Scheduler", function() { return /* reexport */ scheduler_Scheduler; });
__webpack_require__.d(__webpack_exports__, "hot", function() { return /* binding */ hot; });
__webpack_require__.d(__webpack_exports__, "cold", function() { return /* binding */ cold; });
__webpack_require__.d(__webpack_exports__, "time", function() { return /* binding */ time; });
...
var customTestMatchers = {
    toBeNotifications: function (actual, expected) {
        ...
        var message = pass
            ...
            : function () {
                var diffString = Object(external_jest_diff_["diff"])(expectedMarble, actualMarble, {
                    expand: true,
                });
    ...
    toBeSubscriptions: function (actual, expected) {
        ...
        var message = pass
            ...
            : function () {
                var diffString = Object(external_jest_diff_["diff"])(expectedMarbleArray, actualMarbleArray, {
                    expand: true,
                });
...
module.exports = __webpack_require__(/*! /Users/evgenyba/jest-marbles/index.ts */"./index.ts");
