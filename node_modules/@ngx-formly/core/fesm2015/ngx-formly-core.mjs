...
class FormlyFormBuilder {
    ...
    _build(field) {
        ...
        this.getExtensions().forEach((extension) => { var _a; return (_a = extension.prePopulate) === null || _a === void 0 ? void 0 : _a.call(extension, field); });
        this.getExtensions().forEach((extension) => { var _a; return (_a = extension.onPopulate) === null || _a === void 0 ? void 0 : _a.call(extension, field); });
        if (field.fieldGroup) {
            field.fieldGroup.forEach((f) => this._build(f));
        }
        this.getExtensions().forEach((extension) => { var _a; return (_a = extension.postPopulate) === null || _a === void 0 ? void 0 : _a.call(extension, field); });
    }
    getExtensions() {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.2", ngImport: i0, type: FormlyFormBuilder, decorators: [{
        ...
        return [{ type: FormlyConfig }, { type: i0.ComponentFactoryResolver }, { type: i0.Injector }, { type: i2.FormGroupDirective, decorators: [{
                        type: Optional
                    }] }];
    } });
    ...
    fieldChanges(field) {
        ...
        if (field.formControl && !field.fieldGroup) {
            ...
            const sub = valueChanges.subscribe((value) => {
                ...
                if (control instanceof FormControl && ((_a = control['_fields']) === null || _a === void 0 ? void 0 : _a.length) > 1) {
...
class FormlyAttributes {
    ...
    ngOnChanges(changes) {
        ...
        if (changes.field) {
            ...
            this.uiEvents.events.forEach((eventName) => {
                var _a;
                if ((_a = this.to) === null || _a === void 0 ? void 0 : _a[eventName]) {
            ...
            if ((_a = this.to) === null || _a === void 0 ? void 0 : _a.attributes) {
    ...
    onFocus($event) {
        ...
        (_c = (_b = this.to).focus) === null || _c === void 0 ? void 0 : _c.call(_b, this.field, $event);
    }
    onBlur($event) {
        var _a, _b, _c;
        (_a = this.focusObserver) === null || _a === void 0 ? void 0 : _a.setValue(false);
        (_c = (_b = this.to).blur) === null || _c === void 0 ? void 0 : _c.call(_b, this.field, $event);
    }
    onChange($event) {
        var _a, _b, _c;
        (_b = (_a = this.to).change) === null || _b === void 0 ? void 0 : _b.call(_a, this.field, $event);
            ...
            observe(field, ['expressionProperties', key], ({ currentValue: expr }) => {
                if (typeof expr === 'string' || isFunction(expr)) {
                    ...
                    field.hooks.onInit = () => {
                        ...
                        return onInit === null || onInit === void 0 ? void 0 : onInit(field);
                    };
                    const onDestroy = field.hooks.onDestroy;
                    field.hooks.onDestroy = () => {
                        onDestroy === null || onDestroy === void 0 ? void 0 : onDestroy(field);
    ...
    changeHideState(field, hide, resetOnHide) {
        ...
        if (field.formControl && !isNil(field.key)) {
            ...
            if (hide === true && (!c['_fields'] || c['_fields'].every((f) => !!f._hide))) {
                ...
                if (field.resetOnHide && field.fieldArray && ((_a = field.fieldGroup) === null || _a === void 0 ? void 0 : _a.length) !== ((_b = field.model) === null || _b === void 0 ? void 0 : _b.length)) {
...
class FieldFormExtension {
    ...
    setValidators(field) {
        ...
        (_a = field.fieldGroup) === null || _a === void 0 ? void 0 : _a.forEach((f) => f && this.setValidators(f) && (markForCheck = true));
        if (!isNil(field.key) || !field.parent || (isNil(field.key) && !field.fieldGroup)) {
            ...
            if (c && (null === c.validator || null === c.asyncValidator)) {
                c.setValidators(() => {
                    ...
                    return v === null || v === void 0 ? void 0 : v(c);
                });
    ...
    mergeValidators(field, type) {
        ...
        if (field.fieldGroup) {
            field.fieldGroup
                .filter((f) => (f === null || f === void 0 ? void 0 : f.fieldGroup) && isNil(f.key))
...
class CoreExtension {
    ...
    initRootOptions(field) {
        ...
        options.detectChanges = (f) => {
            var _a;
            if (f._componentRefs) {
                f.options.checkExpressions((_a = f.parent) !== null && _a !== void 0 ? _a : f);
                markFieldForCheck(f);
            }
            if (f.fieldGroup) {
    ...
    getFieldComponentInstance(field) {
        const componentRefInstance = () => {
            ...
            if ((fieldComponentRef === null || fieldComponentRef === void 0 ? void 0 : fieldComponentRef['componentType']) === (componentRef === null || componentRef === void 0 ? void 0 : componentRef.componentType)) {
