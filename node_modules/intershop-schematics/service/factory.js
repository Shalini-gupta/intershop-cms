...
function createService(options) {
    return (host) => __awaiter(this, void 0, void 0, function* () {
        ...
        options = yield (0, common_1.detectExtension)('service', host, options);
        options = yield (0, common_1.applyNameAndPath)('service', host, options);
        options = (0, common_1.determineArtifactName)('service', host, options);
        const operations = [];
