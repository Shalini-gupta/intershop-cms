...
function createModel(options) {
    return (host) => __awaiter(this, void 0, void 0, function* () {
        ...
        options = yield (0, common_1.detectExtension)('model', host, options);
        options = yield (0, common_1.applyNameAndPath)('model', host, options);
        options = (0, common_1.determineArtifactName)('model', host, options);
        const operations = [];
        operations.push((0, schematics_1.mergeWith)((0, schematics_1.apply)((0, schematics_1.url)('./files'), [
            !options.simple ? (0, schematics_1.noop)() : (0, schematics_1.filter)(path => path.includes('model.ts')),
